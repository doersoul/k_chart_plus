...
//       onPointerCancel: (event) => _pointers--,
...
//           if (isScale || isLongPress || _pointers > 1) return;
...
//           if (isDrag || isLongPress || _pointers < 2) return;
//           mScaleX = (_lastScale * details.scale).clamp(0.5, 2.2);
//           if (details.focalPointDelta != Offset.zero && mScaleX != _lastScale) {
